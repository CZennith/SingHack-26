...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--data-dir", default="data", help="Directory containing the source CSV and JSON files")
    parser.add_argument("--db-path", default="db/wealth.duckdb", help="Output DuckDB path")
