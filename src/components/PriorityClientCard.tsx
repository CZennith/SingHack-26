        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div>
              ...
              >
                {client.headlineIssue || 'No priority finding calculated from the current backend.'}
              </p>
            </div>
          </div>
        ...
        {!isExpanded && (
          <div className="mt-3 flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-[#f4f3f0]">
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              {client.tags.length === 0 && <span className="text-[10.5px] text-[#888888] font-mono">No backend tags</span>}
          ...
          >
            <div className="p-5 sm:p-6 pt-4 space-y-4">
              ...
              <p className="text-[13px] text-[#555555] leading-relaxed">
                {client.summary || 'Narrative client summary is not calculated by the current backend.'}
              </p>

              {/* Full Tags List */}
              <div className="flex flex-wrap items-center gap-1.5">
                {client.tags.length === 0 && <span className="text-[11px] text-[#888888] font-mono">No backend tags</span>}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 p-3 bg-white border border-[#e8e5e0] text-[11.5px]">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-[#666666] ml-1 font-mono">
                    ({client.portfolio.borrowingLtvPercent === null ? 'Not calculated' : `${client.portfolio.borrowingLtvPercent}%`} LTV)
                  </span>
                </div>
                ...
                <div className="col-span-2 sm:col-span-1 flex flex-col justify-center">
                  <div className="flex items-center justify-between text-[10px] text-[#888888] font-mono mb-1">
                    ...
                    <span>{client.portfolio.borrowingLtvPercent === null ? 'Not calculated' : `${client.portfolio.borrowingLtvPercent}%`}</span>
                  </div>
              ...
              >
                <div className="flex items-start sm:items-center gap-2 text-[12.5px] text-[#121212]">
                  ...
                  <span className="text-[#555555]">{client.suggestedNextStep || 'No recommendation is generated by the current backend.'}</span>
                </div>
